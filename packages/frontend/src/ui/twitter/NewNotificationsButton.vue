...
<template>
<button class="_button" :class="$style.root" type="button" @click="emit('click')">
	<i class="ti ti-circle-arrow-up" aria-hidden="true"></i>
	<span>{{ i18n.tsx._twitterUi.notificationsWithCount({ count }) }}</span>
</button>
</template>
